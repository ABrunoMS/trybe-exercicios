...
numberChecker = (myNumber, number) => myNumber === number;
const number = Math.floor((Math.random() * 5 + 1));

const numbersGenerate = (myNumber, numberChecker) => {
    return numberChecker(myNumber, number)
    
}
console.log(numbersGenerate(3,numberChecker)? `Número sorteado:${number} 
...
const correction = (arrRight, arrStudent, funCompare) => {
